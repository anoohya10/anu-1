...
useEffect(() => {
 ...
 async function save(event)
  ...
  return (
    <div>
       <h1 className="text-bg-info" align="center" >Student Details</h1>
           ...
           <div className="form-group">
              ...
              <div className="form-group">
                ...
                />
                 ...
                 <div>
              <button   className="btn btn-primary mx-auto"  onClick={save}>Register</button> 
              <button   className="btn btn-warning mx-auto"  onClick={update}>Update</button>
              </div>  
</div>
